...
(*cree le vecteur de bits contenant les représentations des nombres en binaire de init à last, ar exemple
...
(*comme la précédente mais en mieux, elle fait des vecteurs qui font tous la même taille,
étudier le fonctionnement elle doit etre pas mal*)
